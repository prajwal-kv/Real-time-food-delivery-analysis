...
checkpointLocation = "s3://stream-checkpointing-one/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.611931653892.us-east-1.redshift-serverless.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-data-one/temp-data/streaming_temp/"
